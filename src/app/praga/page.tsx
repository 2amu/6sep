...
const images = [
  ...
  {
    src: "/praga8.jpeg",
    alt: "Lo mejor de Praga: la habitación",
  },
  {
    src: "/praga5.jpeg",
    alt: "Listos",
  ...
  {
    src: "/praga4.jpeg",
    alt: "Princesa guerrera",
  },
  {
    src: "/praga3.jpeg",
    alt: "Gladiador fortachón",
  }
];
...
const CollagePage: React.FC = () => {
  return (
    <>
      ...
      <h1>Una vida de 2 años juntos<span aria-hidden="true">🫂</span></h1>
            ...
            <img
              ...
              onError={(e) => {
                (e.currentTarget as HTMLImageElement).src =
                  "https://placehold.co/400x300/f5f5f5/333?text=Imagen+no+cargada";
              }}
            />
